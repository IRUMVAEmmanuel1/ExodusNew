		...
		<div class="container">
			<div class="row justify-content-center pb-4">
				<div class="col-md-12 heading-section text-center ftco-animate">
					<span class="subheading">Exodus Provide Places</span>
	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 ftco-animate">
					<div class="project-wrap">
						...
						<div class="text p-4">
							...
							<h3><a href="#">Gishwati National Park</a></h3>
							<p class="location"><span class="fa fa-map-marker"></span> Gishwati Forest, Huye, Southern Province</p>
							<ul>
				...
				<div class="col-md-4 ftco-animate">
					<div class="project-wrap">
						<a href="#" class="img" style="background-image: url(images/nyungwe.JPG);">
							<span class="price">$550/person</span>
						</a>
						<div class="text p-4">
							<span class="days">10 Days Tour</span>
							<h3><a href="#">Nyungwe National Park</a></h3>
							<p class="location"><span class="fa fa-map-marker"></span> Nyungwe, Karongi, Western Province</p>
							<ul>
								<li><span class="flaticon-shower"></span>2</li>
								<li><span class="flaticon-king-size"></span>3</li>
				...
				<div class="col-md-4 ftco-animate">
					<div class="project-wrap">
						<a href="#" class="img" style="background-image: url(images/akagera.JPG);">
							<span class="price">$550/person</span>
						</a>
						<div class="text p-4">
							<span class="days">7 Days Tour</span>
							<h3><a href="#">Akagera National Park</a></h3>
							<p class="location"><span class="fa fa-map-marker"></span> Banaue, Bugesera, Eastern Province</p>
							<ul>
								<li><span class="flaticon-shower"></span>2</li>
								<li><span class="flaticon-king-size"></span>3</li>
								<li><span class="flaticon-sun-umbrella"></span>Near Beach</li>
				...
				<div class="col-md-4 ftco-animate">
					<div class="project-wrap">
						<a href="#" class="img" style="background-image: url(images/volcanoes.JPG);">
							<span class="price">$550/person</span>
						</a>
						<div class="text p-4">
							<span class="days">8 Days Tour</span>
							<h3><a href="#">Volcanoes National Park</a></h3>
							<p class="location"><span class="fa fa-map-marker"></span> Kinigi, Musanze, Northern Province</p>
							<ul>
								<li><span class="flaticon-shower"></span>2</li>
								<li><span class="flaticon-king-size"></span>3</li>
								<li><span class="flaticon-sun-umbrella"></span>Near Beach</li>
				...
				<div class="col-md-4 ftco-animate">
					<div class="project-wrap">
						<a href="#" class="img" style="background-image: url(images/murukari.JPG);">
							<span class="price">$550/person</span>
						</a>
						<div class="text p-4">
							<span class="days">7 Days Tour</span>
							<h3><a href="#">Murukari King Palace</a></h3>
							<p class="location"><span class="fa fa-map-marker"></span> i Bwami, Nyanza, Southern Province</p>
							<ul>
								<li><span class="flaticon-shower"></span>2</li>
								<li><span class="flaticon-king-size"></span>3</li>
								<li><span class="flaticon-sun-umbrella"></span>Near Road</li>
							</ul>
						</div>
					</div>
				</div>
							...
							<div class="testimony-wrap py-4">
								<div class="text">
									...
									<div class="d-flex align-items-center">
										<div class="user-img" style="background-image: url(images/profile1.JPEG)"></div>
										<div class="pl-3">
											<p class="name">Kalisa Emmanuel</p>
											<span class="position">Directing Manager at RDB</span>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								<div class="text">
									...
									<p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
									<div class="d-flex align-items-center">
										<div class="user-img" style="background-image: url(images/profile2.JPG)"></div>
										<div class="pl-3">
											<p class="name">Winny Uwera</p>
											<span class="position">C.E.O at Exodus</span>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								<div class="text">
									...
									<p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
									<div class="d-flex align-items-center">
										<div class="user-img" style="background-image: url(images/profile3.jpeg)"></div>
										<div class="pl-3">
											<p class="name">Umulisa Sonia</p>
							...
							<div class="testimony-wrap py-4">
								<div class="text">
									...
									<div class="d-flex align-items-center">
										<div class="user-img" style="background-image: url(images/profile3.jpeg)"></div>
										<div class="pl-3">
											<p class="name">Umutoni Clarisse</p>
											<span class="position">Marketing Manager</span>
										</div>
									</div>
								</div>
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								<div class="text">
									...
									<p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
									<div class="d-flex align-items-center">
										<div class="user-img" style="background-image: url(images/profile3.JPG)"></div>
										<div class="pl-3">
											<p class="name">Umutoni Clara</p>
											<span class="position">Marketing Manager</span>
										</div>
									</div>
								</div>
